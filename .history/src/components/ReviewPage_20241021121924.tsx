      ...
      const response = await axios.post("/api/extract-pdf-text", formData, {
        ...
        onUploadProgress: (progressEvent) => {
          if (progressEvent.total !== undefined) {
            ...
            console.warn('Upload size cannot be determined');
          }
        },
      });
      ...
      <motion.div className="hero-content flex-col lg:flex-row-reverse" layout>
        ...
        >
          <div className="card-body">
            ...
            {isReviewing && (
              <div className="mt-4">
                <progress className="progress progress-secondary w-full" value={reviewProgress} max="100"></progress>
                <p className="text-center mt-2">Reviewing: {reviewProgress}%</p>
              </div>
            )}
          </div>
        </motion.div>
