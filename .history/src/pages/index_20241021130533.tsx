...
const pageOrder = ['home', 'review', 'polish', 'settings'];
      ...
      <div className="drawer-content flex flex-col">
        ...
        <div
          ...
          className={`flex-grow transition-opacity duration-300 ${
            pageOrder.includes(currentPage) ? "opacity-100" : "opacity-0"
          }`}
        >
